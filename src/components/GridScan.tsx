...
const GridScanComponent: React.FC<GridScanProps> = ({
    ...
    useEffect(() => {
        ...
        const uniforms = {
            iResolution: {
                // We will update this in onResize, but start with safe defaults
                value: new THREE.Vector3(container.clientWidth || 100, container.clientHeight || 100, renderer.getPixelRatio())
            },
            iTime: { value: 0 },
...
export const GridScan = React.memo(GridScanComponent);
